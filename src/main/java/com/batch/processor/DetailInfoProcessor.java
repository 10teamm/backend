		...
		if("32".equals(String.valueOf(content.getContentTypeId()))) {
			...
			List<RecurInformationRoom> rooms = items.item().stream().map(dto -> {
				RecurInformationRoom room = RecurInformationRoom.builder()
					...
					.roomBathFacility(Boolean.valueOf(dto.roombathfacility()))
					.roomBath(Boolean.valueOf(dto.roombath()))
					.roomHomeTheater(Boolean.valueOf(dto.roomhometheater()))
					.roomAircondition(Boolean.valueOf(dto.roomaircondition()))
					.roomTv(Boolean.valueOf(dto.roomtv()))
					.roomPc(Boolean.valueOf(dto.roompc()))
					.roomCable(Boolean.valueOf(dto.roomcable()))
					.roomInternet(Boolean.valueOf(dto.roominternet()))
					.roomRefrigerator(Boolean.valueOf(dto.roomrefrigerator()))
					.roomToiletries(Boolean.valueOf(dto.roomtoiletries()))
					.roomSofa(Boolean.valueOf(dto.roomsofa()))
					.roomCook(Boolean.valueOf(dto.roomcook()))
					.roomTable(Boolean.valueOf(dto.roomtable()))
					.roomHairdryer(Boolean.valueOf(dto.roomhairdryer()))
